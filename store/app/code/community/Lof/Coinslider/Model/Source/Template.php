 ...
 * @author    
 */
class Lof_Coinslider_Model_Config_Source_Template
{
    ...
    {
		//$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . $package;
		$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . 'default' . DS . 'default' .  DS . 'template'.  DS . 'lof_coinslider'. DS . 'content';

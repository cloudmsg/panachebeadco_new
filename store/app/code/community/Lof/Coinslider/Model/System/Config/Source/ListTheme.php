 ...
 * @author    
 */
class Lof_Coinslider_Model_System_Config_Source_ListTheme
{
    ...
    public function toOptionArray()
    {
		...
		$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . 'default' . DS . 'default' .  DS . 'template'.  DS . 'lof'. DS .'coinslider';

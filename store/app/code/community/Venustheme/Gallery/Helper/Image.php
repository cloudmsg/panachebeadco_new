...
class Venustheme_Gallery_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('venustheme_gallery/banner_image'));
     ...
     *
     * @see venustheme_gallery_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return venustheme_gallery_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return venustheme_gallery_Model_Banner_Image
     */

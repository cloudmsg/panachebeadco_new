...
class Venustheme_Sideproduct_Block_Adminhtml_Banner_Add_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    {	
        $this->addTab('general_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('venustheme_sideproduct/adminhtml_banner_add_tab_form')->toHtml(),
        ));

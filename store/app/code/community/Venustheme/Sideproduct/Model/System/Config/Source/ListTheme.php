<?php
class Venustheme_Sideproduct_Model_System_Config_Source_ListTheme
{
    ...
    public function toOptionArray()
    {
		...
		$directory = Mage::getBaseDir('skin') . DS . 'frontend' . DS . 'default' . DS . 'default' .  DS .  'venustheme_sideproduct';

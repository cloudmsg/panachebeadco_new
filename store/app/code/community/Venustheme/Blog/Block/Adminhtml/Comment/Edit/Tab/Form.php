...
-------------------------------------------------------------------------*/
class Venustheme_Blog_Block_Adminhtml_Comment_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('comment_form', array('legend'=>Mage::helper('venustheme_blog')->__('General Information')));
		...
		$fieldset->addField('user', 'text', array(
            'label'     => Mage::helper('venustheme_blog')->__('User'),
            'name'      => 'user',
 
            //'value'     => $_model->getIsActive()
        ));
		$fieldset->addField('email', 'text', array(
            'label'     => Mage::helper('venustheme_blog')->__('Email'),
            'name'      => 'user',
		...
		$fieldset->addField('comment', 'editor', array(
            'label'     => Mage::helper('venustheme_blog')->__('Comment'),
	  ...
	  public function getParentToOptionArray() {
		$catCollection = Mage::getModel('venustheme_blog/comment')
					->getCollection();

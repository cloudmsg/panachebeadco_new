...
class Venustheme_Blog_Block_Adminhtml_Category_Edit_Tab_Param extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('category_params', array('legend'=>Mage::helper('venustheme_blog')->__('Parameter')));

...
class Venustheme_Blog_Block_Adminhtml_Comment_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset = $form->addFieldset('comment_meta', array('legend'=>Mage::helper('venustheme_blog')->__('Meta Information')));

...
-------------------------------------------------------------------------*/
class Venustheme_Blog_Block_Adminhtml_Post_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
    {
		...
		$fieldset = $form->addFieldset('post_meta', array('legend'=>Mage::helper('venustheme_blog')->__('Meta Information')));
		...
		$fieldset->addField('identifier', 'text', array(
            'label'     => Mage::helper('venustheme_blog')->__('Identifier'),
            'class'     => 'required-entry',
            'required'  => true,
            'name'      => 'identifier',
        ));
		$fieldset->addField('category_id', 'select', array(
            'label'     => Mage::helper('venustheme_blog')->__('Category'),
            'class'     => 'required-entry',
            'required'  => true,
            'name'      => 'category_id',
			'values'   => Mage::helper('venustheme_blog')->getCategoriesList()
        ));
		$fieldset->addField('tags', 'text', array(
            'label'     => Mage::helper('venustheme_blog')->__('Tags'),
            'class'     => '',
            'required'  => false,
            'name'      => 'tags',
        ));
		...
		$fieldset->addField('hits', 'text', array(
            'label'     => Mage::helper('venustheme_blog')->__('Hits'),
            'class'     => 'required-entry',
            'required'  => false,
            'name'      => 'hits',
			//'value'     => $_model->getPosition()
	...
	$fieldset->addField('description', 'editor', array(
		...
		$fieldset->addField('detail_content', 'editor', array(
            'label'     => Mage::helper('venustheme_blog')->__('Content'),
            'class'     => 'required-entry',
            'required'  => false,
            'name'      => 'detail_content',

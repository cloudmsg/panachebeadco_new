...
-------------------------------------------------------------------------*/
class Venustheme_Blog_Adminhtml_PostController extends Mage_Adminhtml_Controller_Action {
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('venustheme_blog/post');
    ...
    public function indexAction() {
        ...
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('venustheme_blog/adminhtml_post') );
        $this->renderLayout();
   ...
   public function editAction() {		
        ...
        $_model  = Mage::getModel('venustheme_blog/post')->load($postId);
		...
		$this->_addContent($this->getLayout()->createBlock('venustheme_blog/adminhtml_post_edit'))
				->_addLeft($this->getLayout()->createBlock('venustheme_blog/adminhtml_post_edit_tabs'));
    ...
    public function saveAction() {
        ...
        if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != '') {					
				...
				foreach( $sizes as $key => $size ){
					$c = Mage::getStoreConfig( 'venustheme_blog/general_setting/'.$key );
					$tmp = explode( "x", $c );
            ...
            $_model = Mage::getModel('venustheme_blog/post');
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('venustheme_blog')->__('Record was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('venustheme_blog')->__('Unable to find record to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function deleteAction() {
        if( $this->getRequest()->getParam('id') > 0 ) {
            try {
                $model = Mage::getModel('venustheme_blog/post');
    ...
    public function massStatusAction() {
        ...
        if(!is_array($IDList)) {
            ...
            try {
                foreach ($IDList as $itemId) {
                    $_model = Mage::getSingleton('venustheme_blog/post')

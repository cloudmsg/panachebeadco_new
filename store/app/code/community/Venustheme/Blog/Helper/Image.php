...
class Venustheme_Blog_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('venustheme_blog/banner_image'));
     ...
     *
     * @see venustheme_blog_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return venustheme_blog_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return venustheme_blog_Model_Banner_Image
     */

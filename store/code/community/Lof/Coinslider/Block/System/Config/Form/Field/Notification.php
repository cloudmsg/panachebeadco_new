 ...
 */
class Lof_Coinslider_Block_System_Config_Form_Field_Notification extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		
		$url  = Mage::getBaseUrl('js');
		$jspath = $url.'lof_coinslider/form/script.js';
		$csspath = $url.'lof_coinslider/form/style.css';

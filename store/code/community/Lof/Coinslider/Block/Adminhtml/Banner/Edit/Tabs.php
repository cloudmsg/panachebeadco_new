 ...
 * @author    
 */
class Lof_Coinslider_Block_Adminhtml_Banner_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('lof_coinslider/adminhtml_banner_edit_tab_form')->toHtml(),
        ));
